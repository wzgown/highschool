...
export const ReferenceService = {
  ...
  methods: {
     ...
     * 获取志愿推荐（基于一模/二模成绩）
     *
     * @generated from rpc highschool.v1.ReferenceService.GetVolunteerRecommendations
     */
    getVolunteerRecommendations: {
      name: "GetVolunteerRecommendations",
      I: GetVolunteerRecommendationsRequest,
      O: GetVolunteerRecommendationsResponse,
      kind: MethodKind.Unary,
    },
  }
} as const;
