...
import { ExamType } from "@/gen/highschool/v1/reference_service_pb";
import type { SchoolWithQuota, SchoolForUnified, RecommendedSchool, ScoreConversion } from "@/gen/highschool/v1/reference_service_pb";

export type { District, MiddleSchool, School, SchoolDetail, HistoryScore, SchoolWithQuota, SchoolForUnified, RecommendedSchool, ScoreConversion };
export { ExamType };
