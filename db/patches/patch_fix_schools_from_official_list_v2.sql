-- ============================================================================
-- 修复 ref_school 表中的学校数据（基于2025年官方招生名单）V2
-- 生成时间: 2026-02-22
-- ============================================================================
...
-- ============================================================================
-- 第三部分：添加缺失的学校（不指定ID，让数据库自动生成）
-- ============================================================================

-- 徐汇区缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('044223', '上海市紫竹园中学', '紫竹园中学', 3, 'PUBLIC', 'DISTRICT_FEATURED', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

-- 长宁区缺失（华东政法大学附属中学 - code 054013 可能已存在但名称错误，上面已修正）

-- 静安区缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('064020', '上海田家炳中学', '田家炳中学', 5, 'PRIVATE', 'DISTRICT_MODEL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

-- 普陀区缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('074016', '上海音乐学院附属安师实验中学', '安师实验', 6, 'PUBLIC', 'DISTRICT_FEATURED', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

-- 宝山区缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('133002', '上海师范大学附属宝山罗店中学', '罗店中学', 10, 'PUBLIC', 'DISTRICT_FEATURED', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('134002', '上海市通河中学', '通河中学', 10, 'PUBLIC', 'DISTRICT_MODEL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

-- 闵行区缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('124115', '上海闵行区协和双语教科学校', '协和教科', 9, 'PRIVATE', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

-- 浦东新区缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('153002', '华东师范大学附属东昌中学', '东昌中学', 12, 'PUBLIC', 'DISTRICT_FEATURED', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154009', '上海市香山中学', '香山中学', 12, 'PUBLIC', 'DISTRICT_FEATURED', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('152009', '上海市川沙中学友仁分校', '川沙友仁', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154008', '上海市泾南中学', '泾南中学', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154010', '上海市沪新中学', '沪新中学', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154015', '上海市育民中学', '育民中学', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154017', '上海第二工业大学附属龚路中学', '龚路中学', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154020', '上海市江镇中学', '江镇中学', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154024', '华东师范大学张江实验中学', '张江实验', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154026', '上海市三林中学东校', '三林东校', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154028', '上海市川沙中学北校', '川沙北校', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('154045', '上海市高东中学', '高东中学', 12, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

-- 市属学校缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('155054', '上海科技大学附属学校', '上科大附校', 1, 'PUBLIC', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

-- 金山区缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('164005', '上海市民办交大南洋中学', '交大南洋', 13, 'PRIVATE', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;

-- 奉贤区缺失
INSERT INTO ref_school (code, full_name, short_name, district_id, school_nature_id, school_type_id, boarding_type_id, has_international_course, is_active, created_at, updated_at)
VALUES ('204020', '上海美达菲双语高级中学', '美达菲', 16, 'PRIVATE', 'GENERAL', 'DAY', FALSE, TRUE, NOW(), NOW())
ON CONFLICT (code) DO NOTHING;
...
-- 显示修改后的统计
SELECT '修正后的学校总数' as description, COUNT(*) as count FROM ref_school;
