...
CREATE INDEX IF NOT EXISTS idx_middle_school_student_count ON ref_middle_school(district_id) WHERE exact_student_count IS NOT NULL OR estimated_student_count IS NOT NULL;
