...
-- 首先插入嘉定区的初中学校
INSERT INTO ref_middle_school (name, district_id, school_nature_id, is_non_selective) VALUES
('上海市嘉定区启良中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区方泰中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市曹杨二中附属江桥实验中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区迎园中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区南苑中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区黄渡中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区徐行中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区马陆育才联合中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市民办嘉一联合中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PRIVATE'), FALSE, 2024),
('上海市嘉定区丰庄中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区外冈中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海民办华曜嘉定初级中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PRIVATE'), FALSE, 2024),
('上海市嘉定区震川中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海大学附属嘉定留云中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('交大附中附属嘉定德富中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('同济大学附属实验中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区华江中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区新城实验中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区南翔中学', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区疁城实验学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区戬浜学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区朱桥学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区苏民学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市民办远东学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PRIVATE'), FALSE, 2024),
('上海市民办桃李园实验学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PRIVATE'), FALSE, 2024),
('上海市嘉定区华亭学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区娄塘学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海外国语大学嘉定外国语学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024),
('上海市嘉定区练川实验学校', (SELECT id FROM ref_district WHERE code = 'JD'), (SELECT id FROM ref_school_nature WHERE code = 'PUBLIC'), TRUE, 2024)
