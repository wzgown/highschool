...
-- 插入交大附中附属嘉定洪德中学
INSERT INTO ref_middle_school (code, name, district_id, is_active, created_at, updated_at)
SELECT 'JD0016', '交大附中附属嘉定洪德中学', d.id, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
